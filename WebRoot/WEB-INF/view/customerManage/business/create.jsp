							...
							<div class="form-group field-business-owner_name">
								...
								<div class="col-sm-8">
									<input type="text" id="business-owner_name"
										...
										dialog-title="选择所属人" dialog-url="/manage/select-user.html" value="" readonly="readonly"
										placeholder="负责人" onclick="selectEmployee()"><input type="hidden" id="employeeId"/>
								</div>
...
<script type="text/javascript">
	...
	function addBuness() {
		...
		data.employeeName=$("#business-owner_name").val();
		var str = /^\+?[1-9][0-9]*$/;
