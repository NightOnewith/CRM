						...
						<div class="form-group field-task-content">
							...
							<div class="col-sm-8">
								<textarea id="advanceContent" class="form-control"
									name="description" rows="6" placeholder="内容" readonly="readonly">${businessDto.visitContent }</textarea>
							</div>
						</div>
						<div class="form-group field-task-subject required">
							<label class="control-label col-sm-2" for="task-subject">下次推进时间</label>
							<div class="col-sm-8">
								<input type="date" id="visitTime_id" class="form-control" 
									name="visitTime" />
								<!-- 	<input
								type="hidden" id="creator"
								value="2" /> -->
...
<div class="form-group field-task-content">
							...
							<div class="col-sm-8">
								<textarea id="advanceContent2" class="form-control"
...
<script type="text/javascript">
	function addTuiJin() {
		...
		data.advanceStatus = $("#advanceStatus").val(); // option:selected
		data.description =$("#advanceContent2").val();
		data.visitTime=$("#visitTime_id").val();
