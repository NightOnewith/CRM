                    ...
                    <form id="w0" class="form-horizontal" action="view/customerManage/business/index.jsp" method="get">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group field-business-owner_name">
                                ...
                                <div class="col-sm-8">
                                	<input type="hidden" id="business-owner_name" value="${businessDto.employeeId }"/>
                                    <input type="text" id="business-owner_name2" onclick="selectEmployee()" class="owner_name form-control weiBoxs-dialog" name="Business[owner_name]" value="${businessDto.employeeName }"  dialog-size="large" dialog-title="选择所属人" dialog-url="/manage/select-user.html" placeholder="负责人">
                                </div>
                            ...
                            <div class="form-group field-business-selectcustomer required">
                                ...
                                <div class="col-sm-8">
                                	<input type="hidden" value="${businessDto.customerId }" id="customerId"/>
                                    <input type="text" id="business-selectcustomer" onclick="selectCustomer()" class="selectCustomer form-control weiBoxs-dialog" name="Business[selectCustomer]" value="${businessDto.customerName}" placeholder="点击选择客户" dialog-callback="actionCallBacks" dialog-title="选择客户" dialog-url="/customer/dialog-list.html"/>
                                </div>
                                <div class="help-block help-block-error"></div>
                            </div>
                            <div class="form-group field-business-selectcontacts required">
                                ...
                                <div class="col-sm-8">
                                	<input type="hidden" id="linkManId" value="${businessDto.linkMainId }"/>
                                    <input type="text" id="business-selectcontacts" onclick="selectLinkMan()" class="selectContacts form-control weiBoxs-dialog" name="Business[selectContacts]"  value="${businessDto.name }" placeholder="点击选择联系人" dialog-title="选择联系人" dialog-size="large" dialog-url="/contacts/dialog-list.html">
                                </div>
                                <div class="help-block help-block-error"></div>
                            </div>
                            <div class="form-group field-business-name required">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="business-name" class="form-control" name="Business[name]" value="${businessDto.businessName }" onfocus="$(this).onlypressnum();" placeholder="商机名">
                                </div>
                                <div class="help-block help-block-error"></div>
                            </div>
                            <div class="form-group field-business-type required">
                                ...
                                <input type="hidden" id="sjlx" value="1">
                                    <select id="business-type" class="form-control" name="Business[type]">
										...
										<c:forEach items="${businessTypes}" var="bt">
                            ...
                            <div class="form-group field-business-origin required">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select id="business-origin" class="form-control" name="Business[origin]">
                                        <option value="">请选择...</option>
                                        <c:forEach items="${businessSources}" var="bs">
										<option value="${bs.sourceId }">${bs.sourceName}</option>
									</c:forEach>
                                    </select>
                                </div>
                                <div class="help-block help-block-error"></div>
                            ...
                            <div class="form-group field-business-gain_rate required">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="business-gain_rate" class="form-control" name="Business[gain_rate]" value="${businessDto.probability }" onfocus="$(this).onlypressnum();" placeholder="赢单率">
                            ...
                            <div class="form-group field-business-estimate_price required">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="business-estimate_price" class="form-control" name="Business[estimate_price]" value="${businessDto.persalePrice }" onfocus="$(this).onlypressnum();" placeholder="预计价格">
                                </div>
                                <div class="help-block help-block-error"></div>
                            </div>
                            <div class="form-group field-business-nextstep_time required">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input type="text" id="business-nextstep_time" class="form-control form_datetime" name="Business[nextstep_time]" onclick="changeType()"  value="<fmt:formatDate value="${businessDto.visitTime}"
                            ...
                            <div class="form-group field-business-nextstep required">
                                ...
                                <div class="col-sm-8">
                                    <textarea id="business-nextstep" class="form-control" name="Business[nextstep]" style="height:80px;" placeholder="下次联系内容">${businessDto.visitContent }</textarea>
                                </div>
                                <div class="help-block help-block-error"></div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                            	<input type="hidden" id="businessId" value="${businessDto.businessId }">
...
<!-- 							<caption>响应式表格布局</caption> -->
							...
							<c:forEach items="${employeeDtos }" var="em">
							<tbody>
							
									<tr>
										<td>
											<input type="radio"  name ="radioNameEmployee" style=" opacity: 1;margin-top: -6px " id="${em.employeeId }"/>
											
										</td>
										<td id="${em.employeeId }_kg">${em.employeeName }
										</td>
										<td>${em.postionName }</td>
										<td>${em.phone }</td>
									</tr>
							</tbody>
						</c:forEach>
...
<!-- 							<caption>响应式表格布局</caption> -->
							<thead>
								...
								<c:forEach items="${linkMains }" var="lm">
							<tbody>
							
									<tr>
										<td>
											<input type="radio"  name ="radioName" style=" opacity: 1;margin-top: -6px " id="${lm.linkMainId}"/>
											
										</td>
										<td id="${lm.linkMainId }_lg">${lm.name }
										</td>
										<td>${lm.nickname }</td>
										<td>${lm.phonenum }</td>
									</tr>
				...
				<div class="modal-body">
					<table id="exampleCustomer" class="table">
						<thead>
							...
							<c:forEach items="${customerDtos}" var="cu">
							<tbody>
									<tr>
										<td>
											<input type="radio"  name =radioNameCustomer style=" opacity: 1;margin-top: -6px " id="${cu.customerId }"/>
											
										</td>
										<td id="${cu.customerId }_gk">${cu.customerName }
										</td>
										<td>${cu.fieldName }</td>
										<td>${cu.sourceName }</td>
									</tr>
	...
	<!-- <script type="text/javascript">
		$(function(){
			$("#business-selectcustomer").val('${BusinessDto.customerName}');
		});
	</script> -->
	...
	function postCheckInfoEmployee(){
		...
		for ( var i = 0; i < list.length; i++) {
			if (list[i].checked==true) {
				var id=list[i].id;
				var textName=document.getElementById(id+"_kg").innerText;
				$("#business-owner_name2").val("");
				$("#business-owner_name").val("");
				$("#business-owner_name2").val(textName);
				$("#business-owner_name").val(id);
			}
		}
	...
	function postCheckDocInfoCustomer(){
		...
		data.employeeId=$("#business-owner_name").val();
