        ...
        <div class="widget-container fluid-height clearfix mwi1200">
            ...
            <div class="widget-content padded clearfix">
                <form id="actionform" class="form-horizontal" action="view/customerManage/contacts/index.jsp" method="get">
                    <input type="hidden" name="_csrf" value="${CustomerDto.employeeName }">
...
<!--                                    dialog-url="/customer/dialog-list.html"> -->
							  <input type="text" id="contacts-selectcustomer"
										...
										dialog-callback="actionCallBacks" dialog-title="选择客户" value="${CustomerDto.customerName }"
										dialog-url="/customer/dialog-list.html"
										onclick="selectCustomer()"> <input type="hidden" id="customerId" value="${ CustomerDto.customerId}"/>
                        </div>
                        <div class="help-block help-block-error"></div>
                    </div> 
                    <input type="hidden" id="customer_id" name="Contacts[customer_id]" value="${linkMain.customerId }">

                    <div class="form-group field-contacts-name required">
                        <label class="control-label col-sm-2" for="contacts-name">姓名</label>

                        <div class="col-sm-8">
                            <input type="text" id="contacts-name" class="form-control" name="Contacts[name]" value="${linkMain.name }"
                    ...
                    <div class="form-group field-contacts-sex required">
                        ...
                        <div class="col-sm-8">
                            <input type="hidden" name="Contacts[sex]" id="sexid" value="${linkMain.sex }">
                    ...
                    <div class="form-group field-contacts-honorific required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts-honorific" class="form-control" name="Contacts[honorific]"
                                   value="${linkMain.position }" maxlength="20" placeholder="尊称">
                        </div>
                        <div class="help-block help-block-error"></div>
                    </div>
                    <div class="form-group field-contacts-post">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts-post" class="form-control" name="Contacts[post]" value="${linkMain.nickname }"
                    ...
                    <div class="form-group field-contacts-mobile required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts-mobile" class="form-control" name="Contacts[mobile]"
                                   value="${linkMain.phonenum }" placeholder="手机" maxlength="11">
                        </div>
                        <div class="help-block help-block-error"></div>
                    </div>
                    <div class="form-group field-contacts-email required">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts-email" class="form-control" name="Contacts[email]"
                                   value="${linkMain.email }" placeholder="电子邮箱">
                        </div>
                        <div class="help-block help-block-error"></div>
                    </div>
                    <div class="form-group field-contacts-qq">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="contacts-qq" class="form-control" name="Contacts[qq]"
                                   value="${linkMain.qq }" placeholder="QQ">
                        </div>
                        <div class="help-block help-block-error"></div>
                    </div>
                    <div class="form-group field-contacts-remarks">
                        ...
                        <div class="col-sm-8">
                            <textarea id="contacts-remarks" class="form-control" name="Contacts[remarks]"
                                      maxlength="255" placeholder="备注">${linkMain.remarks }</textarea>
                        </div>
                        <div class="help-block help-block-error"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                        	<input type="hidden" id="linkManid" value="${linkMain.linkMainId }">
				...
				<div class="modal-body">
					<table id="example" class="table">
						<thead>
							...
							<tbody>
							<c:forEach items="${list2 }" var="CustomerDto">
									<tr>
										<td>
											<input type="radio"  name ="radioNameCustomer" style=" opacity: 1;margin-top: -6px " id="${CustomerDto.customerId }"/>
											
										</td>
										<td id="${CustomerDto.customerId }_gk">${CustomerDto.customerName }
											
										</td>
										<td>${CustomerDto.fieldName }</td>
										<td>${CustomerDto.sourceId }</td>
									</tr>
						</c:forEach>
							</tbody>
					</table>
	...
	function postCheckInfoCustomer(){
		...
		for ( var i = 0; i < list.length; i++) {
			if (list[i].checked==true) {
				...
				$("#contacts-selectcustomer").val("");
				$("#customerId").val("");
				$("#contacts-selectcustomer").val(textName);
				$("#customerId").val(id);
			}
		}
		$("#myModal").modal("hide");
