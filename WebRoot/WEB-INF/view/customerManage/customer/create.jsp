...
<body class="navbar-top">
					...
					<form id="w0" class="form-horizontal">
						...
						<div class="form-group field-customer-customer_industry required">
							...
							<div class="col-sm-8">
								<select id="FIELD_ID" class="form-control" name="FIELD_ID">
									...
									<c:forEach items="${list}" var="workingfieldlistss">
						...
						<div class="form-group field-customer-customer_origin required">
							...
							<%-- 	<c:forEach items="${list2 }" var="businesssourcelist">
								<option value="${businesssourcelist.sourceId }>${businesssourcelist}"></option>
								</c:forEach> --%>
								...
								<div id="customer-customer_origin">
									<c:forEach items="${list2 }" var="businesssourcelist"
										...
										<label class="label-radio inline"> <input type="radio"
											...
											value="${businesssourcelist.sourceId }" checked> <span
											class="custom-radio"></span> ${businesssourcelist.sourceName}
										</label>
									</c:forEach>
						...
						<div class="form-group field-customer-customer_zipcode required">
							<label class="control-label col-sm-2"
								for="customer-customer_zipcode">地址</label>

							<div class="col-sm-8">
								<input type="text" id="ADDRESS" class="form-control"
									name="ADDRESS" maxlength="6" placeholder="地址">
							</div>
							<div class="help-block help-block-error"></div>
						</div>
	...
	<script type="text/javascript">
		...
		function addCustomer() {
			...
			if (data.busubessVolume != null && data.busubessVolume != ""
					&& data.busubessVolume != "undefined") {

			} else {
				alert("请选择年营业额");
				return;
			}
			if (data.employeeNumbers != null && data.employeeNumbers != ""
					&& data.employeeNumbers != "undefined") {
