    ...
    <div class="container-fluid main-nav clearfix">
        <div class="nav-collapse">
            <ul class="nav">
                ...
                <c:forEach items="${sessionScope.menus }" var="parentMenu">
              	<li class="">
                	<a href="${parentMenu.menuUrl }" class="" data-toggle="dropdown" data-hover="dropdown">
						<span aria-hidden="true" class="${parentMenu.pictures}"></span>${parentMenu.menuName }<b class="caret"></b>
                	</a>
                    <ul class="dropdown-menu">
                    	<c:forEach items="${parentMenu.sonMenus }" var="sonMenu">
                        	<li><a href="${sonMenu.menuUrl }" class="">${sonMenu.menuName }</a></li>
                        </c:forEach>
                    </ul>
                </li>
              </c:forEach>
